...
<div class="w-full">
    ...
    <form class="grid grid-cols-5 gap-4 h-fit rounded-b-2xl bg-white p-5" method="post" enctype="multipart/form-data">
        ...
        <div>
            ...
            <img src="/akademi/asset/image/teachers/<?= Session::get_recent_input('currentImage') ?? $teacher['image'] ?>" class="h-24 w-24 rounded-full" alt="profile">
            <input type="text" hidden value="PUT" name="_method">
            <input type="text" hidden value="<?= $teacher['image'] ?>" name="currentImage">
            <input type="text" hidden name="current_email" value="<?= Session::get_recent_input('current_email') ?? $teacher['email'] ?>" />
        </div>
        <!-- Column 1 -->
        <div class="flex flex-col gap-2 col-span-2">
            <div class="flex flex-col gap-2">
                ...
                <input type="file" accept=".jpg, .png, .jpeg" name="photo" id="photo" class="border border-gray-300 h-8 rounded-md" value="<?= $teacher['image'] ?>">
            </div>
            <div class="flex flex-col gap-2 ">
                <label for="firstName" class="text-indigo-900 font-bold text-sm">First Name *</label>
                <input placeholder="John" type="text" name="firstName" id="firstName" class="border border-gray-300 h-8 rounded-md" value="<?= Session::get_recent_input('firstName') ?? $teacher['firstName'] ?>">
            ...
            <div class="flex flex-col gap-2">
                ...
                <input placeholder="Doe" type="text" name="lastName" id="lastName" class="border border-gray-300 h-8 rounded-md" value="<?= Session::get_recent_input('lastName') ?? $teacher['lastName'] ?>">
                <p class="text-red-500 text-xs">
            ...
            <div class="flex flex-col gap-2">
                ...
                <input type="date" name="dateOfBirth" id="dateOfBirth" class="border border-gray-300 h-8 rounded-md" value="<?= Session::get_recent_input('dateOfBirth') ?? $teacher['dateOfBirth'] ?>">
                <p class="text-red-500 text-xs">
        ...
        <div class="flex flex-col gap-2 col-span-2">
            <div class="flex flex-col gap-2">
                ...
                <input placeholder="johndoe@gmail.com" type="email" name="email" id="email" class="border border-gray-300 h-8 rounded-md" value="<?= Session::get_recent_input('email') ?? $teacher['email'] ?>">
                <p class="text-red-500 text-xs">
            ...
            <div class="flex flex-col gap-2">
                ...
                <input placeholder="92********" type="text" name="phoneNumber" id="phoneNumber" class="border border-gray-300 h-8 rounded-md" value="<?= Session::get_recent_input('phoneNumber') ?? $teacher['phoneNumber'] ?>">
                <p class="text-red-500 text-xs">
            ...
            <div class="flex flex-col gap-2">
                ...
                <textarea placeholder="California, USA" type="text" name="address" id="address" class="border border-gray-300 h-20 rounded-md"><?= Session::get_recent_input('address') ?? $teacher['address'] ?></textarea>
                <p class="text-red-500 text-xs">
